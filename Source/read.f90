...
IF (SPECIES(SOOT_INDEX)%MODE /= AEROSOL_SPECIES)  THEN
...
SPECIES_MIXTURE(SOOT_INDEX)%AWM_INDEX = N_SURFACE_DENSITY_SPECIES
...
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                ID,IDEAL,LOWER_OXYGEN_LIMIT,N,NU,N_S,N_T,O,PRIORITY,RADIATIVE_FRACTION,RAMP_AIT,RAMP_CHI_R,REAC_ATOM_ERROR,&
...
INTEGER  :: N,NN,NM,MESH_NUMBER=0,N_DEVC_READ,IOR,TRIP_DIRECTION,VELO_INDEX,POINTS,I_POINT,PIPE_INDEX,ORIENTATION_INDEX, &
            ORIENTATION_NUMBER,GHOST_CELL_IOR(3),N_INTERVALS
...
CHARACTER(LABEL_LENGTH) :: QUANTITY,QUANTITY2,PROP_ID,CTRL_ID,DEVC_ID,INIT_ID,SURF_ID,SPATIAL_STATISTIC,TEMPORAL_STATISTIC,&
                 STATISTICS,PART_ID,MATL_ID,SPEC_ID,UNITS, &
...
NAMELIST /DEVC/ ABSOLUTE_VALUE,BYPASS_FLOWRATE,CONVERSION_FACTOR,CONVERSION_ADDEND,COORD_FACTOR,CELL_L,CTRL_ID,DELAY,DEPTH,&
                DEVC_ID,DRY,DUCT_ID,EVACUATION,FLOWRATE,FYI,GHOST_CELL_IOR,HIDE_COORDINATES,ID,INITIAL_STATE,INIT_ID,IOR,LATCH,&
                MATL_ID,NODE_ID,NO_UPDATE_DEVC_ID,NO_UPDATE_CTRL_ID,ORIENTATION,ORIENTATION_NUMBER,OUTPUT,PART_ID,PIPE_INDEX,&
...
NAMELIST /BNDF/ CELL_CENTERED,FYI,PART_ID,PROP_ID,QUANTITY,SPEC_ID,STATISTICS,TEMPORAL_STATISTIC

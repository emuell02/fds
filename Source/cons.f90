...
INTEGER, PARAMETER :: H_CUSTOM=-1,H_DEFAULT=0,H_LOGLAW=1,H_ABL=2,H_RAYLEIGH=3,H_YUAN=4,&
                      H_FREE_HORIZONTAL_CYLINDER=5,H_MORGAN=6                               ! Heat transfer coefficient model
...
LOGICAL :: RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           POSITIVE_ERROR_TEST=.FALSE.  ! If T, replace 'ERROR' with 'SUCCESS' label in certain error messages
                                        ! Used to allow verification cases that check for error conditions in Firebot
